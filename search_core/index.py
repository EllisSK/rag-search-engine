...
class InvertedIndex:
    ...
    def build(self):
        movie_path = DATA_DIR / "movies.json"
    ...
    def save(self):
        ...
        term_freq_cache_path = CACHE_DIR / "term_frequencies.pkl"
    ...
    def bm25_search(self, query: str, limit: int, k1: float, b: float):
        tokens = sanitise_text(query, self.stopwords)
        ...
        for doc_id in self.docmap.keys():
            doc_total = 0.0
            for token in tokens:
                bm25 = self.bm25(doc_id, token, k1, b)
                doc_total += bm25
